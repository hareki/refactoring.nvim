...
local function command_preview(opts, ns)
  ...
  local keys = require("refactoring").refactor(refactor, { _preview_namespace = ns })
...
local function command(opts)
  ...
  if not refactor then return end
