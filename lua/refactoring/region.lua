...
function Region:is_empty()
  if self.start_row == 0 and self.start_col == 0 and self.end_row == 0 and self.end_col == 0 then return true end
  return false
end
...
function Region:to_ts()
  return self.start_row - 1, self.start_col - 1, self.end_row - 1, self.end_col
end
...
function Region:contains(region)
  if region.bufnr ~= self.bufnr then return false end

  return self:get_start_point():leq(region:get_start_point()) and self:get_end_point():geq(region:get_end_point())
end
...
function Region:above(region)
  ...
  return self:get_start_point():lt(region:get_start_point()) and self:get_end_point():lt(region:get_start_point())
end
